...
Original file is located at
    https://colab.research.google.com/drive/1urnizOIyf_VMu41BgXQBcxtz_R1z2R-F
"""
...
summary = pd.read_csv("/data/saiful/Text_Summarization/Text_Summarization_with_Seq2Seq_Model/news_summary.csv", encoding='iso-8859-1')
raw = pd.read_csv("/data/saiful/Text_Summarization/Text_Summarization_with_Seq2Seq_Model/news_summary_more.csv", encoding='iso-8859-1')
...
# !export SPACY_MODEL_PATH = '/data/saiful/spacy/'
# ! python -m spacy download en_core_web_sm
...
# !source "/home/saiful/anaconda3/envs/text_summary/bin/activate"
...
time_format = str(datetime.timedelta(seconds=round(execution_time)))
